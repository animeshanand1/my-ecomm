            ...
            {ratingDistribution.map((item) => (
              <div key={item.stars} className={styles.ratingRow}>
                ...
                <i
                  ...
                  style={{ color: "#facc15", margin: "0 4px" }}
                ></i>
        ...
        <div className={styles.review}>
          <div className={styles.reviewHeader}>
            <div className={styles.reviewAuthor}>
              <img
                src="https://placehold.co/40x40/c7d2fe/3730a3?text=AM"
                alt="Alex Mathio"
          ...
          <p className={styles.reviewBody}>
            "Hooligan's dedication to sustainability and ethical practices
            resonates strongly with today's consumers, positioning the brand as
            a responsible choice in the fashion world."
          </p>
        </div>
      </div>
    </section>
